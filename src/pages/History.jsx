...
export default function History() {
  return (
    <div className="history-page page-wrapper">
      ...
      {/* ── FESTIVAL RITUALS ──────────────────────────────── */}
      <Fade>
        <div className="rituals-section container">
          <span className="label">Sacred Practices</span>
          <h2 className="section-title">Four Days of <span>Living Ritual</span></h2>
          <div className="rule" />
          <p className="rituals-intro">
            The Medaram Jathara unfolds over four carefully structured days, each governed by ancient
            Koya ritual traditions. Every moment of the festival is rich with meaning — from the
            arrival of the deities to their ceremonial return to the forest.
          </p>
          <div className="ritual-days">
            {[
              {
                day: 'Day 1',
                title: 'Arrival of Saralamma & Pagididda Raju',
                icon: '🚶',
                desc: `The festival begins with the ceremonial procession of Saralamma's sacred idol from
                       Kannepalli village to the Medaram shrine. Simultaneously, the insignia of Pagididda Raju
                       arrive from Punugondla village. Hundreds of thousands of devotees line the procession route,
                       chanting the goddess's name, beating traditional drums, and showering flower petals. This
                       arrival marks the official commencement of the Jathara and triggers a surge of pilgrims
                       toward the sacred bathing ghat at Jampanna Vagu.`
              },
              {
                day: 'Day 2',
                title: 'The Sacred Arrival of Sammakka',
                icon: '✨',
                desc: `The most emotionally charged day of the Jathara. Sammakka's Kumkum Bharani — the sacred
                       vermilion casket that represents the goddess — is brought down from Chilukalagutta hill
                       by Koya tribal priests in a solemn procession. The priests carry the casket on their
                       shoulders through the forest path to the main shrine. Millions of tearful, ecstatic 
                       devotees receive the goddess's "arrival" with profound reverence. Govindaraju's idol also
                       arrives from Kondai village on this day. By nightfall, all four principal deities
                       are installed on their respective Gaddelu.`
              },
              {
                day: 'Day 3',
                title: 'Maha Darshan — The Peak of the Jathara',
                icon: '🙏',
                desc: `The third day is the peak — the Maha Darshan. All four deities are simultaneously present
                       on their Gaddelu, and the full force of thirty million pilgrims converges on Medaram.
                       Devotees offer Bangaram (jaggery) at the altars, fulfilling vows made since the last
                       Jathara. Some offer jaggery equal to their own body weight. Tribal priests conduct
                       unbroken prayers and rituals. The air is filled with the sound of traditional drums,
                       the Koya Dommari (dance), and the collective fervour of millions. Medical teams,
                       a city-scale administration, and the Telangana government work silently in the background
                       to support the immense human gathering.`
              },
              {
                day: 'Day 4',
                title: 'Tallula Vanapravesham — Return to the Forest',
                icon: '🌲',
                desc: `The festival concludes with Tallula Vanapravesham — the ceremonial return of the deities
                       to the forest. The sacred caskets and idols are carried back to their respective village
                       shrines and forest homes. The Kumkum Bharani returns to Chilukalagutta. Saralamma returns
                       to Kannepalli. The Gaddelu become empty once more. The parting is marked by heartfelt
                       emotion — devotees bid farewell to the goddesses, knowing they will wait another two years
                       for this sacred reunion. This moment of departure is as powerful as the arrival, ending
                       the Jathara on a note of both joy and longing.`
              },
            ].map(d => (
              <div key={d.day} className="ritual-day-card">
                <div className="rd-header">
                  <span className="rd-icon">{d.icon}</span>
                  <div>
                    <span className="rd-day">{d.day}</span>
                    <h3 className="rd-title">{d.title}</h3>
                  </div>
                </div>
                <p className="rd-desc">{d.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <Fade>
        <div className="unique-section container">
          <span className="label">Distinct Character</span>
          <h2 className="section-title">What Makes the Jathara <span>Unique</span></h2>
          <div className="rule" />
          <div className="unique-grid">
            {[
              {
                icon: '🚫',
                title: 'No Brahminic Influence',
                desc: 'The Medaram Jathara is one of India\'s very few major festivals entirely free from Vedic or Brahminic tradition. All rituals are performed solely by Koya tribal priests (Koya Doras) — there are no Sanskrit mantras, no sacred fire (havan), and no involvement of Brahmin priests whatsoever.'
              },
              {
                icon: '🎋',
                title: 'No Permanent Stone Idols',
                desc: 'The deities are not represented by anthropomorphic stone or metal idols. Instead, they are symbolised by bamboo staffs smeared with turmeric and vermilion, or by sacred caskets. The deities "arrive" at the shrine for the festival and "return to the forest" after it — reflecting Koya animist beliefs.'
              },
              {
                icon: '🍯',
                title: 'Jaggery as Sacred Gold',
                desc: 'The primary offering at Medaram is not flowers, milk, or coconuts — it is Bangaram (jaggery/bellam), referred to as sacred gold. Devotees offer jaggery blocks — sometimes equal to their own body weight — as the expression of their deepest devotion and gratitude to the goddesses.'
              },
              {
                icon: '🌊',
                title: 'The Sacred Stream Bath',
                desc: 'Taking a holy bath in Jampanna Vagu — named for the warrior son who bled into its waters — is considered an essential ritual act for all pilgrims. This is not merely symbolic purification but an act of direct communion with the sacrifice that gave rise to the Jathara.'
              },
              {
                icon: '🌳',
                title: 'Forest-Dwelling Deities',
                desc: 'The goddesses are believed to "live in the forest" between Jatharas. They are ceremonially invited from the forest to the shrine for four days and returned after. This belief system — of nature-dwelling divine presences — is distinctly animist and unique to the Koya tradition.'
              },
              {
                icon: '🥁',
                title: 'Pure Tribal Music & Ritual',
                desc: 'All accompanying music is tribal — the Dappu (traditional Koya drum), Tudumu (percussion), and other indigenous instruments. Tribal dancers in traditional dress perform the Dommari, a sacred dance form. There is no film music, no commercial entertainment — only raw, ancient tribal expression.'
              },
            ].map(u => (
              <div key={u.title} className="unique-card">
                <span className="unique-icon">{u.icon}</span>
                <h3 className="unique-title">{u.title}</h3>
                <p className="unique-desc">{u.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <Fade>
        <div className="recognition-section container">
          ...
          <div className="rec-grid">
            {[
              { n: '~3 Crore',   t: 'Devotees Attended',       d: 'Estimated attendance at the 2026 Maha Jathara over four days — the world\'s largest tribal congregation' },
              { n: 'World #1',   t: 'Tribal Congregation',     d: 'Recognised as the single largest recurring tribal religious gathering anywhere on Earth' },
              { n: '700+ Years', t: 'Living Tradition',        d: 'The Jathara\'s roots trace back to the 13th century — preserved continuously by the Koya tribal community' },
              { n: '₹250 Cr+',  t: 'Government Investment',   d: 'Roads, medical, sanitation, water and security infrastructure deployed by Telangana government' },
              { n: '5+ States',  t: 'Devotees Travel From',    d: 'Telangana, Andhra Pradesh, Chhattisgarh, Maharashtra, Odisha — a genuinely pan-regional gathering' },
              { n: '1996',       t: 'State Festival Status',   d: 'Declared an official State Festival by the Government of Andhra Pradesh; continued by Telangana after 2014' },
            ].map(r => (
